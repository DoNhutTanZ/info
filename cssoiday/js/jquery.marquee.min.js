...
!(function (e) {
  (e.fn.marquee = function (t) {
    return this.each(function () {
      ...
      if (
        (o.duplicated && v.clone(!0).appendTo(u),
        u.wrapInner(
        ...
        i.removeAttr("style"),
          ...
          o.duplicated &&
            u.find(".js-marquee:last").css({ "margin-bottom": 0 });
        var x = u.find(".js-marquee:first").height() + o.gap;
        o.startVisible && !o.duplicated
          ? ((o._completeDuration =
              ((parseInt(x, 10) + parseInt(y, 10)) / parseInt(y, 10)) *
              o.duration),
            (o.duration = (parseInt(x, 10) / parseInt(y, 10)) * o.duration))
          : (o.duration =
              ((parseInt(x, 10) + parseInt(y, 10)) / parseInt(y, 10)) *
              o.duration);
      ...
      if ((o.duplicated && (o.duration = o.duration / 2), o.allowCss3Support)) {
        var I = document.body || document.createElement("div"),
          ...
          j = "";
        if (
          (I.style.animation && ((j = "@keyframes " + b + " "), (l = !0)),
          l === !1)
        )
      ...
      o.duplicated
        ? (r
            ? o.startVisible
              ...
              : i.css(
                  "margin-top",
                  "up" == o.direction ? y + "px" : "-" + (2 * x - o.gap) + "px"
                )
            : o.startVisible
            ? i.css("margin-left", 0)
            : i.css(
                "margin-left",
                "left" == o.direction ? a + "px" : "-" + (2 * s - o.gap) + "px"
              ),
          o.startVisible || (d = 1))
        : o.startVisible
        ? (d = 2)
      ...
      var B = function () {
        if (
          ...
          r
            ? o.duplicated
              ? (d > 2 &&
                  i.css("margin-top", "up" == o.direction ? 0 : "-" + x + "px"),
                (n = {
              ...
              : (A(),
                (n = {
                  "margin-top":
                    "up" == o.direction ? "-" + i.height() + "px" : y + "px",
                }))
            : o.duplicated
            ? (d > 2 &&
                i.css(
          ...
          var t = j + " { 100%  " + f(n) + "}",
            p = i.find("style");
          0 !== p.length
            ? p.filter(":last").html(t)
            : i.append("<style>" + t + "</style>"),
